...
namespace SharpUpdate
{
    ...
    public class QubedotUpdater
    {
        ...
        /// </summary>
        private QubedotUpdateLocalAppInfo[] LocalApplicationInfos;

        /// <summary>
        /// Holds all the jobs defined in update xml
        /// </summary>
        private QubedotUpdateXml[] JobsFromXML;
        ...
        //private readonly Uri UpdateXmlLocation = new Uri("https://github.com/dennisripp/Test-updater/blob/master/Updater/project.xml");
        //private readonly Uri UpdateXmlLocation = new Uri(new FileInfo(@"C:\Users\denni\Desktop\Test updater\project.xml").FullName);       // for local testing
        ...
        public QubedotUpdater(Assembly a, Form owner, Uri XMLOnServer)
        {
            ParentForm = owner;
            ParentAssembly = a;
        ...
        {
             MessageBoxEx.Show(ParentForm, "Application will be closed", "Success", 1000);
            // UpdateApplications();
             Application.Exit(); 
        }
